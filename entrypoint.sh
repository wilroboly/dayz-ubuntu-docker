...
## File: PterodactylDayZ - entrypoint.sh
## Author: William Roboly
## Borrowed From: Arma 3 entrypoint.sh file.
## Date: 2022/03/21
## License: MIT License
...
GAME_ID=1042420                                  # SteamCMD ID for the Arma 3 GAME (not server). Only used for Workshop mod downloads.
...
# Replace Startup Variables - Pterodactyl
